...
% Analysis of Image Interpolation on the Learnability of Generative and Discriminative Graphical Models
...
\section{Experiment}
To measure the generalziation ability of our models, we plan to train each one
